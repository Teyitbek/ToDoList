...
public extension UIView {
    ...
    func activate(_ anchoredConstraints: [AnchoredConstraints]) {
        for anchoredConstraint in anchoredConstraints {
            [
                anchoredConstraint.centerY,
                anchoredConstraint.centerX,
                anchoredConstraint.top,
                anchoredConstraint.topLessThanEqual,
                anchoredConstraint.topGreaterThanEqual,
                anchoredConstraint.widthGreaterThanConstant,
                anchoredConstraint.leading,
                anchoredConstraint.heightTo,
                anchoredConstraint.heightLessThanConstant,
                anchoredConstraint.heightGreaterThanConstant,
                anchoredConstraint.bottom,
                anchoredConstraint.trailing,
                anchoredConstraint.width,
                anchoredConstraint.height,
                anchoredConstraint.widthTo,
                anchoredConstraint.heightToWidth
            ].forEach {
                if let anchor = $0 {
    ...
    func deactivate(_ anchoredConstraints: [AnchoredConstraints]) {
        for anchoredConstraint in anchoredConstraints {
            [
                anchoredConstraint.centerY,
                anchoredConstraint.centerX,
