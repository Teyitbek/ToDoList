...
public final class ActivityIndicatorView: UIView {
    private let animationKey = "ActivityIndicatorViewAnimationKey"
    ...
    public var colors: [UIColor] = [.white, .white] {
        didSet { drawIndicatorPath() }
    }
    ...
    public var style = ActivityIndicatorViewStyle.gradationColor(head: .black, tail: .lightGray) {
    ...
    @available(*, deprecated)
    public convenience init(style: ActivityIndicatorViewStyle) {
